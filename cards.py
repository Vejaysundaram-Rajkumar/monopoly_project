...
card_values = [
    ...
    (13, 'Speeding fine 150K', 150000, 'chance'),
    (14, 'You have been elected Chairman of the Board Pay each player 150K', 150000, 'chance'),
    ...
    (21, 'Advance to the nearest Station If unowned, you may buy it from the Bank If owned, pay owner twice the rental', 2, 'chance'),
    (22, 'Advance to the nearest Station If unowned, you may buy it from the Bank If owned, pay owner twice the rental', 2, 'chance'),
    (23, 'Advance token to nearest Utility If unowned, you may buy it from the Bank If owned, throw dice and pay owner a total ten times amount thrown', 10000, 'chance'),
